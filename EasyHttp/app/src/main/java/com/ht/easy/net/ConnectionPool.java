...
public class ConnectionPool {
    ...
    private final static Executor executor = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60, TimeUnit.SECONDS,
            new SynchronousQueue<Runnable>(), new ThreadFactory() {
        @Override
        public Thread newThread(@NonNull Runnable r) {
            Thread thread = new Thread(r, "ConnectionPool cleanup Thread");
            //设置为守护线程,下进程生命周期一样
