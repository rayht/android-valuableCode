...
public class Consts {
    ...
    public static final ClassName ROUTER = ClassName.get("com.router.core", "Router");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "com.router.annotation.Route";
    public static final String ANN_TYPE_Extra = "com.router.annotation.Extra";


    public static final String IROUTE_GROUP = "com.router.core.template.IRouteGroup";
    public static final String IROUTE_ROOT = "com.router.core.template.IRouteRoot";
    public static final String IEXTRA = "com.router.core.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "com.router.core.template.IService";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.router.routes";
